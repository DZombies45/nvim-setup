...
```sh
git clone https://github.com/DZombies45/nvim-setup.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/DZombies45/nvim-setup.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/DZombies45/nvim-setup.git "${env:LOCALAPPDATA}\nvim"
```
